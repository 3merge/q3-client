...
import {SecuringNotice} from '../../security';
...
const CheckoutBridge = (ids) => {
  ...
  const isReadyForSubmission = () => Object.values(state).every((v) => {
    return v.isReady
  })
  ...
  return (
    ...
    <form>
      <TextFieldWrapper
        ...
        id={CARD}
      />
      <TextFieldWrapper label={t('labels:cvv')} id={CVV} />
      <TextFieldWrapper label={t('labels:expirry')} id={EXP} />
      <Button
        id={PAY}
        disabled
        type="button"
