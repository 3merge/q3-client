    ...
    <Box component="li" my={1} p={2}>
      ...
      >
        ...
        <g opacity="0.2">
          <path
            fill="#3f3d56"
            d="M765.11 767a23.27 23.27 0 01-2.11 3.25q-10.51-7.39-21.38-14.51l.47-.93a20.53 20.53 0 017.27-7.92c4-2.46 8.51-3 12.22-1s5.78 6 6 10.67a20.6 20.6 0 01-2.47 10.44z"
          ...
          <path
            fill="#ccc"
            d="M816.25 538.5a61.7 61.7 0 01-1-8.58L848.17 541l-32.83-17.08a62.45 62.45 0 0122.08-44.23l31.81 46-24.7-51.16a62.37 62.37 0 1158.36 109.89 62.4 62.4 0 011 13.39l-50-.4 49.28 8.12a62.37 62.37 0 01-36.29 47 62.37 62.37 0 11-86.65-45.89 62.39 62.39 0 0136.1-68.15z"
            transform="translate(-260 -65.95)"
          />
          <path
            d="M896.64 624.71a62.14 62.14 0 01-29.84 27.83 62.37 62.37 0 11-86.65-45.89c-2.42-13.29 119.77 11.87 116.49 18.06z"
            opacity="0.1"
            transform="translate(-260 -65.95)"
          />
        </g>
        <g opacity="0.2">
          <path
            fill="#3f3d56"
            d="M477 687.67a43.27 43.27 0 002.39 7.05q23.11-8.85 46.75-17c-.14-.64-.28-1.3-.44-2a39.53 39.53 0 00-9.83-18.22c-6.29-6.48-14.45-9.64-22.3-7.72s-13.63 8.47-16.24 17.09a39.55 39.55 0 00-.33 20.8z"
            transform="translate(-260 -65.95)"
          />
          <ellipse
            cx="491.83"
          ...
          <path
            fill="#ccc"
            d="M489.38 237a118.65 118.65 0 005.81-15.56l-66.55 5.11L498 210.14a120.32 120.32 0 00-20.33-93L396.55 188l70.26-83.83A120.07 120.07 0 10306 281.72a119.33 119.33 0 00-8.11 24.52l93.59 22.88-95.8-8.12a120.14 120.14 0 0045.54 105 120.07 120.07 0 10183.37-44.75A120.08 120.08 0 00489.38 237z"
            transform="translate(-260 -65.95)"
          />
          <path
            d="M298.66 359.94a119.51 119.51 0 0042.56 66 120.07 120.07 0 10183.37-44.75c10.79-23.64-229.13-34.34-225.93-21.25z"
            opacity="0.1"
            transform="translate(-260 -65.95)"
          />
        </g>
        ...
        <path
          fill="#ececf3"
          d="M762.1 90.09h-41.27v5a23.58 23.58 0 01-23.58 23.57H565.67a23.58 23.58 0 01-23.58-23.57v-5h-38.72a28.63 28.63 0 00-28.63 28.63V756a28.63 28.63 0 0028.63 28.63H762.1A28.63 28.63 0 00790.73 756V118.72a28.63 28.63 0 00-28.63-28.63z"
          transform="translate(-260 -65.95)"
        />
        <ellipse
          cx="87.26"
        ...
        <path
          fill="#ccc"
          d="M370.91 803.68c2.45-2.28 4.75-5 5.45-8.23s-.68-7.19-3.81-8.38c-3.5-1.34-7.24 1.08-10.07 3.53s-6.09 5.25-9.8 4.73a14.9 14.9 0 004.61-14 5.77 5.77 0 00-1.28-2.83c-1.94-2.08-5.46-1.19-7.79.45-7.39 5.2-9.46 15.25-9.5 24.3-.75-3.27-.12-6.67-.14-10s-.93-7.06-3.75-8.86a11.39 11.39 0 00-5.74-1.34c-3.32-.12-7 .21-9.29 2.64-2.83 3-2.09 8.09.36 11.42s6.19 5.41 9.63 7.71c2.61 1.75 5.26 3.79 6.87 6.56a5.91 5.91 0 01.51 1.17H358a58.41 58.41 0 0012.91-8.87z"
          transform="translate(-260 -65.95)"
        />
        <g fill="#ccc" opacity="0.4">
          ...
          />
          <path
            d="M893.51 757.27a9.54 9.54 0 003.12-4.69c.4-1.87-.4-4.11-2.18-4.79-2-.76-4.13.62-5.75 2s-3.47 3-5.59 2.7a8.49 8.49 0 002.63-8 3.26 3.26 0 00-.73-1.61c-1.11-1.19-3.12-.68-4.44.25-4.22 3-5.4 8.71-5.43 13.87-.42-1.86-.06-3.8-.07-5.71s-.54-4-2.15-5.06a6.52 6.52 0 00-3.27-.76c-1.9-.07-4 .12-5.31 1.5-1.61 1.73-1.19 4.62.21 6.52s3.53 3.09 5.5 4.4a12.29 12.29 0 013.92 3.74 3.39 3.39 0 01.29.67h11.9a33 33 0 007.35-5.03z"
            transform="translate(-260 -65.95)"
          />
        </g>
        <g fill="#ccc" opacity="0.4">
        ...
        <path
          fill="#f86d70"
          d="M544.89 377.33h-32.66c-1-2.23-1.9-4.47-2.91-6.7a4.65 4.65 0 01.59-1.5 1.63 1.63 0 011.34-.75c.29 0 .62.11.83-.1s.14-.38.29-.52.51-.14.79-.12a1.81 1.81 0 001.54-.77 2.46 2.46 0 01.39-.51 2.23 2.23 0 01.84-.22c.81-.18 1.29-1 1.9-1.51a1.14 1.14 0 011.2-.33.74.74 0 01.25.21 2.26 2.26 0 01.33.83 7.42 7.42 0 002.61 4.21 5.92 5.92 0 008.94-2.23 11.64 11.64 0 00.82-3.79v-.17a2.86 2.86 0 012.38.47 13.43 13.43 0 002.12 1.33c.89.35 2 .35 2.61 1 .26.26.44.62.77.78a2.3 2.3 0 00.64.15 3.79 3.79 0 012.51 2.2 17.13 17.13 0 011.4 5.06z"
          transform="translate(-260 -65.95)"
        />
        <path
          fill="#3f3d56"
          d="M519.05 344.05a5.25 5.25 0 00-1.21 1.4 6.89 6.89 0 01-2.42 2.38 3 3 0 00-1.11.69 1.85 1.85 0 00-.29.78 14.63 14.63 0 00-.31 2.95 3.15 3.15 0 00.24 1.46c.2.42.58.78.65 1.24a3.62 3.62 0 01-.12 1.08.94.94 0 00.37 1 2.54 2.54 0 00.56.13c1 .22 1.34 1.4 1.49 2.37.34 0 .49-.41.57-.73l1-4.65c.12-.5.3-1.09.81-1.26a2.53 2.53 0 011.06 0c1.38.12 2.54-.95 3.89-1.25a5.3 5.3 0 011.32-.08c1.06 0 2.3.49 2.53 1.48 0 .16.06.36.21.44a.84.84 0 00.47 0c.67-.07 1.07.69 1.27 1.31l.7 2.27c.11.34.29.75.66.79a.7.7 0 00.69-.61 2.77 2.77 0 00-.14-1c-.33-1.48.18-3 .49-4.49s.36-3.2-.68-4.35c-.38-.41-.88-.72-1.23-1.16s-.51-.91-.85-1.32a8.73 8.73 0 00-4.85-2.12 9.94 9.94 0 00-5.77 1.25z"
          transform="translate(-260 -65.95)"
        />
        <g opacity="0.1">
          <path
            d="M531.43 356.77c-.37 0-.55-.45-.66-.79l-.7-2.27c-.2-.62-.6-1.38-1.27-1.32a.84.84 0 01-.47 0c-.15-.08-.17-.27-.21-.44-.23-1-1.47-1.43-2.53-1.48a4.87 4.87 0 00-1.32.09c-1.35.29-2.51 1.36-3.89 1.24a2.92 2.92 0 00-1.06 0c-.51.18-.69.76-.81 1.27a203 203 0 00-1 4.64c-.08.32-.23.71-.57.73-.15-1-.49-2.15-1.49-2.37a2.08 2.08 0 01-.56-.13.63.63 0 01-.29-.33c0 .14-.06.29-.08.43a.94.94 0 00.37 1 2.54 2.54 0 00.56.13c1 .22 1.34 1.4 1.49 2.37.34 0 .49-.41.57-.73.35-1.55.69-3.1 1-4.65.12-.5.3-1.09.81-1.26a2.53 2.53 0 011.06 0c1.38.12 2.54-.95 3.89-1.25a5.3 5.3 0 011.32-.08c1.06 0 2.3.49 2.53 1.48 0 .16.06.36.21.44a.84.84 0 00.47 0c.67-.07 1.07.69 1.27 1.31l.7 2.27c.11.34.29.75.66.79a.7.7 0 00.69-.61 2 2 0 00-.1-.8.62.62 0 01-.59.32zM514.6 353.89c-.07-.46-.45-.82-.65-1.24a2.54 2.54 0 01-.23-.9v.5a3.15 3.15 0 00.24 1.46c.16.34.44.64.58 1a2.23 2.23 0 00.06-.82zM532.47 350.68a13 13 0 00-.57 4 24.28 24.28 0 01.57-2.92 7.66 7.66 0 00.17-2.24 9.06 9.06 0 01-.17 1.16z"
            transform="translate(-260 -65.95)"
          />
        </g>
        <path
          fill="#f86d70"
          d="M514.84 377.33h-7.79a24.5 24.5 0 011.83-6.08 1.39 1.39 0 01.33-.53.48.48 0 01.11-.09c.23-.18.55-.25.8-.42s.28-.35.51-.42a6.91 6.91 0 012.54.42 2.54 2.54 0 01.67.17 2.26 2.26 0 011.06 1.3c.66 1.79.16 3.73-.06 5.65z"
          transform="translate(-260 -65.95)"
        />
      </svg>
      ...
      <Typography>{t('descriptions:empty')}</Typography>
    </Box>
  );
};
